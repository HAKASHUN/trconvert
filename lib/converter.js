var GraphicsConverter  = require('./lib/GraphicsConverter');
var TransformConverter = require('./lib/TransformConverter');
var TweenConverter     = require('./lib/TweenConverter');
var RectangleConverter = require('./lib/RectangleConverter');
var SetRectangleConverter = require('./lib/SetRectangleConverter');
var TextConverter      = require('./lib/TextConverter');
var CacheConverter     = require('./lib/CacheConverter');
var fs                 = require('fs');
var path               = require('path');
var _                  = require('lodash');

var TFCRatioConverter = function (file, ratio, base) {
